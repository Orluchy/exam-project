...
Custom subdomain linked through No-IP.
...
Check Your Website In your browser, go to the public IP address of your EC2 instance (e.g., http://your-elastic-ip) to confirm that your HTML page is being served.
4. Acquiring a Domain from No-IP
Registration:
Register an account on No-IP.
